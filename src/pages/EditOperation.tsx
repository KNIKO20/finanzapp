          ...
          {errorMessage && (
              ...
              <form onSubmit={handleSubmit} >
                  ...
                  <div className="mb-6 flex justify-between">
                    <ComboBoxResponsiveType value={selectedType} onChange={handleChangeType}></ComboBoxResponsiveType>
                    <ComboBoxResponsiveCategory value={selectedCategory} onChange={handleChangeCategory}></ComboBoxResponsiveCategory>
                  </div>
                  
                <div className="flex content-between">
                  <Button className="text-neutral-50 m-2">UPDATE</Button>
